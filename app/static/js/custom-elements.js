...
class editTaskButton extends HTMLElement {
    constructor() {
        super();
    }
    ...
    connectedCallback() {
        this.innerHTML = `
            <a class="editLink mr-3 text-primary text-decoration-none" data-bs-toggle="modal" data-bs-target="#editTask">
...
class deleteTaskButton extends HTMLElement {
    constructor() {
        super();
    }
    ...
    connectedCallback() {
        this.innerHTML = `
            <span class="delete-task text-danger text-decoration-none">
...
customElements.define('edit-task-button', editTaskButton);
customElements.define('delete-task-button', deleteTaskButton);